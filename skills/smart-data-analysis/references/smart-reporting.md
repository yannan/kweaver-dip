...
| 报告内顺序 | 步骤内容 |
| --- | --- |
| 1 | 识别报告场景（`table_search` / `sql_query` / `data_insights` / `attribution_analysis_report`） |
