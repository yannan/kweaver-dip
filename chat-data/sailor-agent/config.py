...
class Settings(BaseSettings):
    ...
    AGENT_OPERATOR_INTEGRATION_HOST: str = os.getenv("AGENT_OPERATOR_INTEGRATION_HOST", "agent-operator-integration")
    AGENT_OPERATOR_INTEGRATION_PORT: str = os.getenv("AGENT_OPERATOR_INTEGRATION_PORT", "9000")
