...
const MetricCreate = lazy(() => import('./Metric/Create'));
const MetricDetail = lazy(() => import('./Metric/Detail'));
        ...
        <Router basename={(window as any).__POWERED_BY_QIANKUN__ ? props.history.getBasePath : '/vega'}>
          ...
          >
            <Switch>
              ...
              <Route exact path="/ontology/metric/create" render={() => <MetricCreate />} />
              <Route exact path="/ontology/metric/edit/:metricId" render={() => <MetricCreate />} />
              <Route exact path="/ontology/metric/detail/:metricId" render={() => <MetricDetail />} />
